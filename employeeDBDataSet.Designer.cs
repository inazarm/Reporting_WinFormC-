...
namespace RDLC_Reporting {
    ...
    public partial class employeeDBDataSet : global::System.Data.DataSet {
        ...
        public partial class EmployeesDataTable : global::System.Data.TypedTableBase<EmployeesRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public EmployeesRow AddEmployeesRow(string FirstName, string LastName, string Gender, decimal Salary) {
...
namespace RDLC_Reporting.employeeDBDataSetTableAdapters {
    ...
    public partial class EmployeesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Employees] SET [FirstName] = @FirstName, [LastName] = @LastName, [Gender] = @Gender, [Salary] = @Salary WHERE (([Id] = @Original_Id) AND ((@IsNull_FirstName = 1 AND [FirstName] IS NULL) OR ([FirstName] = @Original_FirstName)) AND ((@IsNull_LastName = 1 AND [LastName] IS NULL) OR ([LastName] = @Original_LastName)) AND ((@IsNull_Gender = 1 AND [Gender] IS NULL) OR ([Gender] = @Original_Gender)) AND ((@IsNull_Salary = 1 AND [Salary] IS NULL) OR ([Salary] = @Original_Salary)));
SELECT Id, FirstName, LastName, Gender, Salary FROM Employees WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::RDLC_Reporting.Properties.Settings.Default.employeeDBConnectionString;
        }
        ...
        public virtual int Delete(int Original_Id, string Original_FirstName, string Original_LastName, string Original_Gender, global::System.Nullable<decimal> Original_Salary) {
        ...
        public virtual int Insert(string FirstName, string LastName, string Gender, global::System.Nullable<decimal> Salary) {
            if ((FirstName == null)) {
        ...
        public virtual int Update(string FirstName, string LastName, string Gender, global::System.Nullable<decimal> Salary, int Original_Id, string Original_FirstName, string Original_LastName, string Original_Gender, global::System.Nullable<decimal> Original_Salary, int Id) {
            if ((FirstName == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string FirstName, string LastName, string Gender, global::System.Nullable<decimal> Salary, int Original_Id, string Original_FirstName, string Original_LastName, string Original_Gender, global::System.Nullable<decimal> Original_Salary) {
            return this.Update(FirstName, LastName, Gender, Salary, Original_Id, Original_FirstName, Original_LastName, Original_Gender, Original_Salary, Original_Id);
        }
    }
